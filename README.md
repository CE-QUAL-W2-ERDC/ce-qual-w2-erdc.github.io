...
## CE-QUAL-W2 Model Capabilities (PSU Version 4.5 and ERDC Version 2026)
...
## CE-QUAL-W2 Model Limitations (Version 2026)

ERDC's CE-QUAL-W2 Version 2026 is based on the latest V4.5 version developed by Portland State University (PSU). V2026 contains the following additional features:

- Harmful Algal Bloom (HAB) capabilities:
    - Nitrogen fixation
    - Algal harvesting
    - Hypoxic conditions (bloom collapse associated with low dissolved oxygen conditions)
    - Minimum algae concentration (to maintain seed population after bloom collapse)
- Compiled for gfortran
- Supports Windows, MacOS, Linux, and High-Performance Computers (HPC)

CE-QUAL-W2 functions under the following general assumptions:

- Flows are assumed to be well mixed in lateral direction (can be used in a Quasi-3-D mode via additional model branches).
- Hydrostasis is assumed for the vertical momentum equation.

## Point of Contact

* Water Quality and Contaminant Modeling Branch, Environmental Laboratory, U.S. Army Engineer Research and Development Center

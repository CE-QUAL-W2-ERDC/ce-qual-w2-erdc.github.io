...
| Floating treatment wetlands | Nutrient uptake and sequestration by emergent macrophytes grown on buoyant platforms | The model includes a submerged macrophyte module, but it does not represent emergent or floating macrophyte configurations | Parameterize nutrient uptake using the macrophyte module in near-surface segments, or reduce inflow or in-reservoir nutrient concentrations proportionally to estimated wetland uptake rates |
